...
class BigOpportunityEventTest {
    ...
    void giveNegativeCashFlow_whenBigOpportunityEvent_thenSubtractCaseAndAddExpense() throws InsufficientCashException {
        ...
        // 負債增加
        Assertions.assertEquals(BigOpportunityEventType.BEDROOMS3_LIVING2_FOR_SALE.getMortgage(), financialStatement.getLiability().getTotalLiabilityAmount().subtract(originalLiability));
    }
